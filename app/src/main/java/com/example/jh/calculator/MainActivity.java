package com.example.jh.calculator;
...
//        XiaomiUpdateAgent.update(this);
    ...
    public void freshBitKeyboard(long a) {
        ...
        if (bit0.getText().toString().equals("1"))
            bit0.setTextColor(getResources().getColor(R.color.blue));
        else bit0.setTextColor(getResources().getColor(R.color.black));
        if (bit1.getText().toString().equals("1"))
            bit1.setTextColor(getResources().getColor(R.color.blue));
        else bit1.setTextColor(getResources().getColor(R.color.black));
        if (bit2.getText().toString().equals("1"))
            bit2.setTextColor(getResources().getColor(R.color.blue));
        else bit2.setTextColor(getResources().getColor(R.color.black));
        if (bit3.getText().toString().equals("1"))
            bit3.setTextColor(getResources().getColor(R.color.blue));
        else bit3.setTextColor(getResources().getColor(R.color.black));
        if (bit4.getText().toString().equals("1"))
            bit4.setTextColor(getResources().getColor(R.color.blue));
        else bit4.setTextColor(getResources().getColor(R.color.black));
        if (bit5.getText().toString().equals("1"))
            bit5.setTextColor(getResources().getColor(R.color.blue));
        else bit5.setTextColor(getResources().getColor(R.color.black));
        if (bit6.getText().toString().equals("1"))
            bit6.setTextColor(getResources().getColor(R.color.blue));
        else bit6.setTextColor(getResources().getColor(R.color.black));
        if (bit7.getText().toString().equals("1"))
            bit7.setTextColor(getResources().getColor(R.color.blue));
        else bit7.setTextColor(getResources().getColor(R.color.black));
        if (bit8.getText().toString().equals("1"))
            bit8.setTextColor(getResources().getColor(R.color.blue));
        else bit8.setTextColor(getResources().getColor(R.color.black));
        if (bit9.getText().toString().equals("1"))
            bit9.setTextColor(getResources().getColor(R.color.blue));
        else bit9.setTextColor(getResources().getColor(R.color.black));
        if (bit10.getText().toString().equals("1"))
            bit10.setTextColor(getResources().getColor(R.color.blue));
        else bit10.setTextColor(getResources().getColor(R.color.black));
        if (bit11.getText().toString().equals("1"))
            bit11.setTextColor(getResources().getColor(R.color.blue));
        else bit11.setTextColor(getResources().getColor(R.color.black));
        if (bit12.getText().toString().equals("1"))
            bit12.setTextColor(getResources().getColor(R.color.blue));
        else bit12.setTextColor(getResources().getColor(R.color.black));
        if (bit13.getText().toString().equals("1"))
            bit13.setTextColor(getResources().getColor(R.color.blue));
        else bit13.setTextColor(getResources().getColor(R.color.black));
        if (bit14.getText().toString().equals("1"))
            bit14.setTextColor(getResources().getColor(R.color.blue));
        else bit14.setTextColor(getResources().getColor(R.color.black));
        if (bit15.getText().toString().equals("1"))
            bit15.setTextColor(getResources().getColor(R.color.blue));
        else bit15.setTextColor(getResources().getColor(R.color.black));
        if (bit16.getText().toString().equals("1"))
            bit16.setTextColor(getResources().getColor(R.color.blue));
        else bit16.setTextColor(getResources().getColor(R.color.black));
        if (bit17.getText().toString().equals("1"))
            bit17.setTextColor(getResources().getColor(R.color.blue));
        else bit17.setTextColor(getResources().getColor(R.color.black));
        if (bit18.getText().toString().equals("1"))
            bit18.setTextColor(getResources().getColor(R.color.blue));
        else bit18.setTextColor(getResources().getColor(R.color.black));
        if (bit19.getText().toString().equals("1"))
            bit19.setTextColor(getResources().getColor(R.color.blue));
        else bit19.setTextColor(getResources().getColor(R.color.black));
        if (bit20.getText().toString().equals("1"))
            bit20.setTextColor(getResources().getColor(R.color.blue));
        else bit20.setTextColor(getResources().getColor(R.color.black));
        if (bit21.getText().toString().equals("1"))
            bit21.setTextColor(getResources().getColor(R.color.blue));
        else bit21.setTextColor(getResources().getColor(R.color.black));
        if (bit22.getText().toString().equals("1"))
            bit22.setTextColor(getResources().getColor(R.color.blue));
        else bit22.setTextColor(getResources().getColor(R.color.black));
        if (bit23.getText().toString().equals("1"))
            bit23.setTextColor(getResources().getColor(R.color.blue));
        else bit23.setTextColor(getResources().getColor(R.color.black));
        if (bit24.getText().toString().equals("1"))
            bit24.setTextColor(getResources().getColor(R.color.blue));
        else bit24.setTextColor(getResources().getColor(R.color.black));
        if (bit25.getText().toString().equals("1"))
            bit25.setTextColor(getResources().getColor(R.color.blue));
        else bit25.setTextColor(getResources().getColor(R.color.black));
        if (bit26.getText().toString().equals("1"))
            bit26.setTextColor(getResources().getColor(R.color.blue));
        else bit26.setTextColor(getResources().getColor(R.color.black));
        if (bit27.getText().toString().equals("1"))
            bit27.setTextColor(getResources().getColor(R.color.blue));
        else bit27.setTextColor(getResources().getColor(R.color.black));
        if (bit28.getText().toString().equals("1"))
            bit28.setTextColor(getResources().getColor(R.color.blue));
        else bit28.setTextColor(getResources().getColor(R.color.black));
        if (bit29.getText().toString().equals("1"))
            bit29.setTextColor(getResources().getColor(R.color.blue));
        else bit29.setTextColor(getResources().getColor(R.color.black));
        if (bit30.getText().toString().equals("1"))
            bit30.setTextColor(getResources().getColor(R.color.blue));
        else bit30.setTextColor(getResources().getColor(R.color.black));
        if (bit31.getText().toString().equals("1"))
            bit31.setTextColor(getResources().getColor(R.color.blue));
        else bit31.setTextColor(getResources().getColor(R.color.black));
        if (bit32.getText().toString().equals("1"))
            bit32.setTextColor(getResources().getColor(R.color.blue));
        else bit32.setTextColor(getResources().getColor(R.color.black));
        if (bit33.getText().toString().equals("1"))
            bit33.setTextColor(getResources().getColor(R.color.blue));
        else bit33.setTextColor(getResources().getColor(R.color.black));
        if (bit34.getText().toString().equals("1"))
            bit34.setTextColor(getResources().getColor(R.color.blue));
        else bit34.setTextColor(getResources().getColor(R.color.black));
        if (bit35.getText().toString().equals("1"))
            bit35.setTextColor(getResources().getColor(R.color.blue));
        else bit35.setTextColor(getResources().getColor(R.color.black));
        if (bit36.getText().toString().equals("1"))
            bit36.setTextColor(getResources().getColor(R.color.blue));
        else bit36.setTextColor(getResources().getColor(R.color.black));
        if (bit37.getText().toString().equals("1"))
            bit37.setTextColor(getResources().getColor(R.color.blue));
        else bit37.setTextColor(getResources().getColor(R.color.black));
        if (bit38.getText().toString().equals("1"))
            bit38.setTextColor(getResources().getColor(R.color.blue));
        else bit38.setTextColor(getResources().getColor(R.color.black));
        if (bit39.getText().toString().equals("1"))
            bit39.setTextColor(getResources().getColor(R.color.blue));
        else bit39.setTextColor(getResources().getColor(R.color.black));
        if (bit40.getText().toString().equals("1"))
            bit40.setTextColor(getResources().getColor(R.color.blue));
        else bit40.setTextColor(getResources().getColor(R.color.black));
        if (bit41.getText().toString().equals("1"))
            bit41.setTextColor(getResources().getColor(R.color.blue));
        else bit41.setTextColor(getResources().getColor(R.color.black));
        if (bit42.getText().toString().equals("1"))
            bit42.setTextColor(getResources().getColor(R.color.blue));
        else bit42.setTextColor(getResources().getColor(R.color.black));
        if (bit43.getText().toString().equals("1"))
            bit43.setTextColor(getResources().getColor(R.color.blue));
        else bit43.setTextColor(getResources().getColor(R.color.black));
        if (bit44.getText().toString().equals("1"))
            bit44.setTextColor(getResources().getColor(R.color.blue));
        else bit44.setTextColor(getResources().getColor(R.color.black));
        if (bit45.getText().toString().equals("1"))
            bit45.setTextColor(getResources().getColor(R.color.blue));
        else bit45.setTextColor(getResources().getColor(R.color.black));
        if (bit46.getText().toString().equals("1"))
            bit46.setTextColor(getResources().getColor(R.color.blue));
        else bit46.setTextColor(getResources().getColor(R.color.black));
        if (bit47.getText().toString().equals("1"))
            bit47.setTextColor(getResources().getColor(R.color.blue));
        else bit47.setTextColor(getResources().getColor(R.color.black));
        if (bit48.getText().toString().equals("1"))
            bit48.setTextColor(getResources().getColor(R.color.blue));
        else bit48.setTextColor(getResources().getColor(R.color.black));
        if (bit49.getText().toString().equals("1"))
            bit49.setTextColor(getResources().getColor(R.color.blue));
        else bit49.setTextColor(getResources().getColor(R.color.black));
        if (bit50.getText().toString().equals("1"))
            bit50.setTextColor(getResources().getColor(R.color.blue));
        else bit50.setTextColor(getResources().getColor(R.color.black));
        if (bit51.getText().toString().equals("1"))
            bit51.setTextColor(getResources().getColor(R.color.blue));
        else bit51.setTextColor(getResources().getColor(R.color.black));
        if (bit52.getText().toString().equals("1"))
            bit52.setTextColor(getResources().getColor(R.color.blue));
        else bit52.setTextColor(getResources().getColor(R.color.black));
        if (bit53.getText().toString().equals("1"))
            bit53.setTextColor(getResources().getColor(R.color.blue));
        else bit53.setTextColor(getResources().getColor(R.color.black));
        if (bit54.getText().toString().equals("1"))
            bit54.setTextColor(getResources().getColor(R.color.blue));
        else bit54.setTextColor(getResources().getColor(R.color.black));
        if (bit55.getText().toString().equals("1"))
            bit55.setTextColor(getResources().getColor(R.color.blue));
        else bit55.setTextColor(getResources().getColor(R.color.black));
        if (bit56.getText().toString().equals("1"))
            bit56.setTextColor(getResources().getColor(R.color.blue));
        else bit56.setTextColor(getResources().getColor(R.color.black));
        if (bit57.getText().toString().equals("1"))
            bit57.setTextColor(getResources().getColor(R.color.blue));
        else bit57.setTextColor(getResources().getColor(R.color.black));
        if (bit58.getText().toString().equals("1"))
            bit58.setTextColor(getResources().getColor(R.color.blue));
        else bit58.setTextColor(getResources().getColor(R.color.black));
        if (bit59.getText().toString().equals("1"))
            bit59.setTextColor(getResources().getColor(R.color.blue));
        else bit59.setTextColor(getResources().getColor(R.color.black));
        if (bit60.getText().toString().equals("1"))
            bit60.setTextColor(getResources().getColor(R.color.blue));
        else bit60.setTextColor(getResources().getColor(R.color.black));
        if (bit61.getText().toString().equals("1"))
            bit61.setTextColor(getResources().getColor(R.color.blue));
        else bit61.setTextColor(getResources().getColor(R.color.black));
        if (bit62.getText().toString().equals("1"))
            bit62.setTextColor(getResources().getColor(R.color.blue));
        else bit62.setTextColor(getResources().getColor(R.color.black));
        if (bit63.getText().toString().equals("1"))
            bit63.setTextColor(getResources().getColor(R.color.blue));
        else bit63.setTextColor(getResources().getColor(R.color.black));
        ...
        for (i = 0; i < stringTemp.length(); i++) {
            if (i == 0) bit_flag_0.setText(String.valueOf(stringTemp.charAt(0)).toUpperCase());
                ...
                bit_flag_12.setText(String.valueOf(stringTemp.charAt(3)).toUpperCase());
            else if (i == 4)
                bit_flag_16.setText(String.valueOf(stringTemp.charAt(4)).toUpperCase());
            else if (i == 5)
                bit_flag_20.setText(String.valueOf(stringTemp.charAt(5)).toUpperCase());
            else if (i == 6)
                bit_flag_24.setText(String.valueOf(stringTemp.charAt(6)).toUpperCase());
            else if (i == 7)
                bit_flag_28.setText(String.valueOf(stringTemp.charAt(7)).toUpperCase());
            else if (i == 8)
                bit_flag_32.setText(String.valueOf(stringTemp.charAt(8)).toUpperCase());
            else if (i == 9)
                bit_flag_36.setText(String.valueOf(stringTemp.charAt(9)).toUpperCase());
            else if (i == 10)
                bit_flag_40.setText(String.valueOf(stringTemp.charAt(10)).toUpperCase());
            else if (i == 11)
                bit_flag_44.setText(String.valueOf(stringTemp.charAt(11)).toUpperCase());
            else if (i == 12)
                bit_flag_48.setText(String.valueOf(stringTemp.charAt(12)).toUpperCase());
            else if (i == 13)
                bit_flag_52.setText(String.valueOf(stringTemp.charAt(13)).toUpperCase());
            else if (i == 14)
                bit_flag_56.setText(String.valueOf(stringTemp.charAt(14)).toUpperCase());
            else if (i == 15)
                bit_flag_60.setText(String.valueOf(stringTemp.charAt(15)).toUpperCase());
    ...
    public void nClickBit1(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit1.getText().equals("1")) {
            stringBuilder.setCharAt(62, '0');
        } else {
            stringBuilder.setCharAt(62, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit2(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit2.getText().equals("1")) {
            stringBuilder.setCharAt(61, '0');
        } else {
            stringBuilder.setCharAt(61, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit3(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit3.getText().equals("1")) {
            stringBuilder.setCharAt(60, '0');
        } else {
            stringBuilder.setCharAt(60, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit4(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit4.getText().equals("1")) {
            stringBuilder.setCharAt(59, '0');
        } else {
            stringBuilder.setCharAt(59, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit5(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit5.getText().equals("1")) {
            stringBuilder.setCharAt(58, '0');
        } else {
            stringBuilder.setCharAt(58, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit6(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit6.getText().equals("1")) {
            stringBuilder.setCharAt(57, '0');
        } else {
            stringBuilder.setCharAt(57, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit7(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit7.getText().equals("1")) {
            stringBuilder.setCharAt(56, '0');
        } else {
            stringBuilder.setCharAt(56, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit8(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit8.getText().equals("1")) {
            stringBuilder.setCharAt(55, '0');
        } else {
            stringBuilder.setCharAt(55, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit9(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit9.getText().equals("1")) {
            stringBuilder.setCharAt(54, '0');
        } else {
            stringBuilder.setCharAt(54, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit10(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit10.getText().equals("1")) {
            stringBuilder.setCharAt(53, '0');
        } else {
            stringBuilder.setCharAt(53, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit11(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit11.getText().equals("1")) {
            stringBuilder.setCharAt(52, '0');
        } else {
            stringBuilder.setCharAt(52, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit12(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit12.getText().equals("1")) {
            stringBuilder.setCharAt(51, '0');
        } else {
            stringBuilder.setCharAt(51, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit13(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit13.getText().equals("1")) {
            stringBuilder.setCharAt(50, '0');
        } else {
            stringBuilder.setCharAt(50, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit14(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit14.getText().equals("1")) {
            stringBuilder.setCharAt(49, '0');
        } else {
            stringBuilder.setCharAt(49, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit15(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit15.getText().equals("1")) {
            stringBuilder.setCharAt(48, '0');
        } else {
            stringBuilder.setCharAt(48, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit16(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit16.getText().equals("1")) {
            stringBuilder.setCharAt(47, '0');
        } else {
            stringBuilder.setCharAt(47, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit17(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit17.getText().equals("1")) {
            stringBuilder.setCharAt(46, '0');
        } else {
            stringBuilder.setCharAt(46, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit18(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit18.getText().equals("1")) {
            stringBuilder.setCharAt(45, '0');
        } else {
            stringBuilder.setCharAt(45, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit19(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit19.getText().equals("1")) {
            stringBuilder.setCharAt(44, '0');
        } else {
            stringBuilder.setCharAt(44, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit20(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit20.getText().equals("1")) {
            stringBuilder.setCharAt(43, '0');
        } else {
            stringBuilder.setCharAt(43, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit21(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit21.getText().equals("1")) {
            stringBuilder.setCharAt(42, '0');
        } else {
            stringBuilder.setCharAt(42, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit22(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit22.getText().equals("1")) {
            stringBuilder.setCharAt(41, '0');
        } else {
            stringBuilder.setCharAt(41, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit23(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit23.getText().equals("1")) {
            stringBuilder.setCharAt(40, '0');
        } else {
            stringBuilder.setCharAt(40, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit24(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit24.getText().equals("1")) {
            stringBuilder.setCharAt(39, '0');
        } else {
            stringBuilder.setCharAt(39, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit25(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit25.getText().equals("1")) {
            stringBuilder.setCharAt(38, '0');
        } else {
            stringBuilder.setCharAt(38, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit26(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit26.getText().equals("1")) {
            stringBuilder.setCharAt(37, '0');
        } else {
            stringBuilder.setCharAt(37, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit27(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit27.getText().equals("1")) {
            stringBuilder.setCharAt(36, '0');
        } else {
            stringBuilder.setCharAt(36, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit28(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit28.getText().equals("1")) {
            stringBuilder.setCharAt(35, '0');
        } else {
            stringBuilder.setCharAt(35, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit29(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit29.getText().equals("1")) {
            stringBuilder.setCharAt(34, '0');
        } else {
            stringBuilder.setCharAt(34, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit30(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit30.getText().equals("1")) {
            stringBuilder.setCharAt(33, '0');
        } else {
            stringBuilder.setCharAt(33, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit31(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit31.getText().equals("1")) {
            stringBuilder.setCharAt(32, '0');
        } else {
            stringBuilder.setCharAt(32, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit32(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit32.getText().equals("1")) {
            stringBuilder.setCharAt(31, '0');
        } else {
            stringBuilder.setCharAt(31, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit33(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit33.getText().equals("1")) {
            stringBuilder.setCharAt(30, '0');
        } else {
            stringBuilder.setCharAt(30, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit34(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit34.getText().equals("1")) {
            stringBuilder.setCharAt(29, '0');
        } else {
            stringBuilder.setCharAt(29, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit35(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit35.getText().equals("1")) {
            stringBuilder.setCharAt(28, '0');
        } else {
            stringBuilder.setCharAt(28, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit36(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit36.getText().equals("1")) {
            stringBuilder.setCharAt(27, '0');
        } else {
            stringBuilder.setCharAt(27, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit37(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit37.getText().equals("1")) {
            stringBuilder.setCharAt(26, '0');
        } else {
            stringBuilder.setCharAt(26, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit38(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit38.getText().equals("1")) {
            stringBuilder.setCharAt(25, '0');
        } else {
            stringBuilder.setCharAt(25, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit39(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit39.getText().equals("1")) {
            stringBuilder.setCharAt(24, '0');
        } else {
    ...
    public void nClickBit40(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit40.getText().equals("1")) {
            stringBuilder.setCharAt(23, '0');
        } else {
            stringBuilder.setCharAt(23, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit41(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit41.getText().equals("1")) {
            stringBuilder.setCharAt(22, '0');
        } else {
            stringBuilder.setCharAt(22, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit42(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit42.getText().equals("1")) {
            stringBuilder.setCharAt(21, '0');
        } else {
    ...
    public void nClickBit43(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit43.getText().equals("1")) {
            stringBuilder.setCharAt(20, '0');
        } else {
            stringBuilder.setCharAt(20, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit44(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit44.getText().equals("1")) {
            stringBuilder.setCharAt(19, '0');
        } else {
            stringBuilder.setCharAt(19, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit45(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit45.getText().equals("1")) {
            stringBuilder.setCharAt(18, '0');
        } else {
            stringBuilder.setCharAt(18, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit46(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit46.getText().equals("1")) {
            stringBuilder.setCharAt(17, '0');
        } else {
            stringBuilder.setCharAt(17, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit47(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit47.getText().equals("1")) {
            stringBuilder.setCharAt(16, '0');
        } else {
            stringBuilder.setCharAt(16, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit48(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit48.getText().equals("1")) {
            stringBuilder.setCharAt(15, '0');
        } else {
            stringBuilder.setCharAt(15, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit49(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit49.getText().equals("1")) {
            stringBuilder.setCharAt(14, '0');
        } else {
            stringBuilder.setCharAt(14, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit50(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit50.getText().equals("1")) {
            stringBuilder.setCharAt(13, '0');
        } else {
            stringBuilder.setCharAt(13, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit51(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit51.getText().equals("1")) {
            stringBuilder.setCharAt(12, '0');
        } else {
            stringBuilder.setCharAt(12, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit52(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit52.getText().equals("1")) {
            stringBuilder.setCharAt(11, '0');
        } else {
            stringBuilder.setCharAt(11, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit53(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit53.getText().equals("1")) {
            stringBuilder.setCharAt(10, '0');
        } else {
            stringBuilder.setCharAt(10, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit54(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit54.getText().equals("1")) {
            stringBuilder.setCharAt(9, '0');
        } else {
            stringBuilder.setCharAt(9, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit55(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit55.getText().equals("1")) {
            stringBuilder.setCharAt(8, '0');
        } else {
            stringBuilder.setCharAt(8, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit56(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit56.getText().equals("1")) {
            stringBuilder.setCharAt(7, '0');
        } else {
            stringBuilder.setCharAt(7, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit57(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit57.getText().equals("1")) {
            stringBuilder.setCharAt(6, '0');
        } else {
            stringBuilder.setCharAt(6, '1');
        }
        stringTemp = stringBuilder.toString();
        tempNum = parseUnsignedLongToBinary(stringTemp);
        freshBitKeyboard(tempNum);
    ...
    public void nClickBit59(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit59.getText().equals("1")) {
            stringBuilder.setCharAt(4, '0');
        } else {
    ...
    public void nClickBit60(View view) {
        stringTemp = numTo64BitBinaryString(tempNum);
        StringBuilder stringBuilder = new StringBuilder(stringTemp);
        if (bit60.getText().equals("1")) {
            stringBuilder.setCharAt(3, '0');
        } else {
